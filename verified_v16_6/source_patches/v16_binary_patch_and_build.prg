...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_6.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_6_SHARED_FEE_UPDATE_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.6 shared fee update build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
