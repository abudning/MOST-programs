...
lcBackup=lcRoot+"backup_v16_38_xp_letter_direct_reload_rx_spaces_20260913\"
lcLog=lcOutput+"build_v16_38_xp_letter_direct_reload_rx_spaces.log"
...
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\openletterwriter_v16_38.prg" TO (lcPrograms+"openletterwriter.prg")
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\letterpatientreloadtimer_v16_38.prg" TO (lcPrograms+"letterpatientreloadtimer.prg")
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\rxcenter_v16_38.prg" TO (lcPrograms+"rxcenter.prg")
...
lcOld='normalized_version("1.7.638")) ;'
lcNew='normalized_version("1.7.638"), normalized_version("1.7.639")) ;'
* Keep the VFP INLIST argument count within its legacy limit by dropping the oldest code-only build.
lcText=STRTRAN(lcText,'normalized_version("1.7.614"), normalized_version("1.7.615")','normalized_version("1.7.615")',1,1,1)
IF lcOld $ lcText
 STRTOFILE(STRTRAN(lcText,lcOld,lcNew,1,1,1),lcOms,0)
ELSE
 IF !('normalized_version("1.7.639")' $ lcText)
...
SCAN
 ...
 IF "V16.35" $ lcProps
  REPLACE properties WITH STRTRAN(lcProps,"V16.35","V16.38",1,-1,1) IN v36version
 ENDIF
 IF "V16.35" $ lcMethods
  REPLACE methods WITH STRTRAN(lcMethods,"V16.35","V16.38",1,-1,1) IN v36version
 ENDIF
ENDSCAN
USE IN v36version
...
PROCEDURE Click
* V16.38 POSITION CLAIMS TO THE RIGHT OF PATIENTS
...
IF FOUND() AND "V16.35 SINGLE LETTERBUILDER" $ v36patients.methods
 REPLACE methods WITH STRTRAN(v36patients.methods,"V16.35 SINGLE LETTERBUILDER","V16.38 SINGLE LETTERBUILDER",1,1,1) IN v36patients
ENDIF
USE IN v36patients
...
BUILD EXE (lcOutput+"MOST_V16_38_XP_LETTER_DIRECT_RELOAD_RX_SPACES.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS V16.38 1.7.639 "+TTOC(DATETIME(),1)+CHR(13)+CHR(10),lcLog,0)
ON ERROR
QUIT
...
MESSAGEBOX(lcError,16,"MOSt V16.38 build")
CANCEL
ENDPROC