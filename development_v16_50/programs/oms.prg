...
llV1615CodeOnly = INLIST(normalized_version(m_current_most_ver), ;
	normalized_version("1.7.627"), normalized_version("1.7.628"), normalized_version("1.7.629"), normalized_version("1.7.630"), normalized_version("1.7.631"), normalized_version("1.7.632"), normalized_version("1.7.633"), normalized_version("1.7.634"), normalized_version("1.7.635"), normalized_version("1.7.636"), normalized_version("1.7.637"), normalized_version("1.7.638"), normalized_version("1.7.639"), normalized_version("1.7.640"), normalized_version("1.7.641"), normalized_version("1.7.642"), normalized_version("1.7.643"), normalized_version("1.7.644"), normalized_version("1.7.645"), normalized_version("1.7.646"), normalized_version("1.7.647"), normalized_version("1.7.648"), normalized_version("1.7.649"), normalized_version("1.7.650"), normalized_version("1.7.651")) ;
