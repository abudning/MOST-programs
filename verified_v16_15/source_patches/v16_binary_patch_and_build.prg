...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_15.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_15_CLAIMS_FEE_RESOURCE_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.15 Claims server fee and resource-safe build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
