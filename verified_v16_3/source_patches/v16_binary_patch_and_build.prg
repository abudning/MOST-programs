...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_3.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_3_TEMP_REPAIR_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.3 private fee-import cursor build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
