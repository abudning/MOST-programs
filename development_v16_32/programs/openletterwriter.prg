...
FOR lnI=1 TO _SCREEN.FormCount
    ...
    IF UPPER(ALLTRIM(loLetterForm.Caption))=="LETTER BUILDER"
        ...
        IF llHasPatient AND lnOpenPatient#lnPatientId
            * Use LetterBuilder's existing patient-number sequence so the current
            * letter is completed/saved exactly as when a new ID is typed there.
            ...
            loLetterForm.pageframe1.page1.search.Valid()
        ELSE
            MESSAGEBOX("LetterBuilder is already open for this patient.",64,"MOSt - One LetterBuilder at a Time")
        ENDIF
        RETURN
    ENDIF
ENDFOR
