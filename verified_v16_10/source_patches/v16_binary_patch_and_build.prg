...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_10.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_10_FEE_RECONCILE_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.10 authoritative fee reconciliation build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
