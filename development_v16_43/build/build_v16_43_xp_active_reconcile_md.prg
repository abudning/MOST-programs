...
lcBackup=lcRoot+"backup_v16_43_xp_active_reconcile_md_20260913\"
lcLog=lcOutput+"build_v16_43_xp_active_reconcile_md.log"
...
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\openletterwriter_v16_43.prg" TO (lcPrograms+"openletterwriter.prg")
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\letterpatientreloadtimer_v16_43.prg" TO (lcPrograms+"letterpatientreloadtimer.prg")
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\rxcenter_v16_43.prg" TO (lcPrograms+"rxcenter.prg")
...
lcOld='normalized_version("1.7.643")) ;'
lcNew='normalized_version("1.7.643"), normalized_version("1.7.644")) ;'
* Keep the VFP INLIST argument count within its legacy limit by dropping the oldest code-only build.
lcText=STRTRAN(lcText,'normalized_version("1.7.619"), normalized_version("1.7.620")','normalized_version("1.7.620")',1,1,1)
IF lcOld $ lcText
 STRTOFILE(STRTRAN(lcText,lcOld,lcNew,1,1,1),lcOms,0)
ELSE
 IF !('normalized_version("1.7.644")' $ lcText)
...
SCAN
 ...
 IF "V16.42" $ lcProps
  REPLACE properties WITH STRTRAN(lcProps,"V16.42","V16.43",1,-1,1) IN v36version
 ENDIF
 IF "V16.42" $ lcMethods
  REPLACE methods WITH STRTRAN(lcMethods,"V16.42","V16.43",1,-1,1) IN v36version
 ENDIF
ENDSCAN
USE IN v36version
...
PROCEDURE Click
* V16.43 POSITION CLAIMS TO THE RIGHT OF PATIENTS
...
IF FOUND() AND "V16.35 SINGLE LETTERBUILDER" $ v36patients.methods
 REPLACE methods WITH STRTRAN(v36patients.methods,"V16.35 SINGLE LETTERBUILDER","V16.43 SINGLE LETTERBUILDER",1,1,1) IN v36patients
ENDIF
USE IN v36patients
...
BUILD EXE (lcOutput+"MOST_V16_43_XP_ACTIVE_RECONCILE_MD.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS V16.43 1.7.644 "+TTOC(DATETIME(),1)+CHR(13)+CHR(10),lcLog,0)
ON ERROR
QUIT
...
MESSAGEBOX(lcError,16,"MOSt V16.43 build")
CANCEL
ENDPROC
