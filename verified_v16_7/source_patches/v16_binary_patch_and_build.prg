...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_7.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_7_FEE_ALIAS_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.7 named fee-import work area build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
