...
title MOSt V16.62 Windows XP Workstation Upgrade
echo MOSt V16.62 - version 1.7.663 - XP TEST CHECKPOINT
...
:choosebackup
set "BACKUP=%TARGET%\Upgrade_Backup_V16_62_%RANDOM%_%RANDOM%"
...
if errorlevel 1 goto restore
echo.
echo SUCCESS: V16.62 / 1.7.663 installed.
echo Previous executable saved in "%BACKUP%".
echo Database files and workstation configuration were not changed.
echo Follow README_V16.62.txt before approving this test build for live use.
pause
exit /b 0
:restore
