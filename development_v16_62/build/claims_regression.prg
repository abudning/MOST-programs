...
lcLog="C:\Users\abudn\Documents\Codex\2026-09-15\ple\work\v16_62_build\output\claims_regression.log"
...
ADD OBJECT billing_md AS ComboBox WITH RowSourceType=3, ColumnCount=3, Style=2, Value=''
...
THIS.billing_md.RowSourceType=3
THIS.billing_md.RowSource="Select md.mnemonic,surname,firstname from MD into cursor tt where payment <> 0"
IF THIS.radiology=1
 THIS.billing_md.RowSource=''
 ...
 GO TOP
 DO WHILE !EOF()
  THIS.billing_md.AddItem(MD.mnemonic,THIS.billing_md.ListCount+1,1)
  THIS.billing_md.List(THIS.billing_md.ListCount,2)=ALLTRIM(MD.surname)
  THIS.billing_md.List(THIS.billing_md.ListCount,3)=ALLTRIM(MD.firstname)
  SKIP
 ENDDO
 THIS.billing_md.AddItem('**',THIS.billing_md.ListCount+1,1)
