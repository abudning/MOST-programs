...
lcRoot="C:\Users\abudn\Documents\Codex\2026-09-15\ple\work\v16_62_build\"
lcMost=lcRoot+"MOSt\"
...
_VFP.ActiveProject.VersionNumber="1.7.663"
...
loFile.Close()
BUILD EXE (lcRoot+"output\MOST_V16_62_XP_CLAIMS_REPAIR.exe") FROM (lcMost+"most.pjx") RECOMPILE
STRTOFILE("SUCCESS V16.62 1.7.663 "+TTOC(DATETIME(),1)+CHR(13)+CHR(10),lcLog,0)
ON ERROR
QUIT
