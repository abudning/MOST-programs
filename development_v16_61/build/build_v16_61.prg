...
lcRoot="C:\Users\abudn\Documents\Codex\2026-09-15\ple\work\v16_61_build\"
lcMost=lcRoot+"MOSt\"
lcLog=lcRoot+"output\build_v16_61.log"
...
_VFP.ActiveProject.VersionNumber="1.7.662"
...
loFile.Close()
BUILD EXE (lcRoot+"output\MOST_V16_61_XP_CLAIMS_REPAIR.exe") FROM (lcMost+"most.pjx") RECOMPILE
STRTOFILE("SUCCESS V16.61 1.7.662 "+TTOC(DATETIME(),1)+CHR(13)+CHR(10),lcLog,0)
ON ERROR
QUIT
