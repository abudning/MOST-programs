...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_8.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_8_FEE_PROGRESS_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.8 responsive third-party fee migration build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
