...
lcBackup=lcRoot+"backup_v16_39_xp_letter_details_rx_sphere_20260913\"
lcLog=lcOutput+"build_v16_39_xp_letter_details_rx_sphere.log"
...
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\openletterwriter_v16_39.prg" TO (lcPrograms+"openletterwriter.prg")
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\letterpatientreloadtimer_v16_39.prg" TO (lcPrograms+"letterpatientreloadtimer.prg")
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\rxcenter_v16_39.prg" TO (lcPrograms+"rxcenter.prg")
...
lcOld='normalized_version("1.7.639")) ;'
lcNew='normalized_version("1.7.639"), normalized_version("1.7.640")) ;'
* Keep the VFP INLIST argument count within its legacy limit by dropping the oldest code-only build.
lcText=STRTRAN(lcText,CHR(9)+'normalized_version("1.7.615"), ;'+CHR(13)+CHR(10),'',1,1,1)
lcText=STRTRAN(lcText,CHR(9)+'normalized_version("1.7.615"), ;'+CHR(10),'',1,1,1)
IF lcOld $ lcText
 STRTOFILE(STRTRAN(lcText,lcOld,lcNew,1,1,1),lcOms,0)
ELSE
 IF !('normalized_version("1.7.640")' $ lcText)
...
SCAN
 ...
 IF "V16.35" $ lcProps
  REPLACE properties WITH STRTRAN(lcProps,"V16.35","V16.39",1,-1,1) IN v36version
 ENDIF
 IF "V16.35" $ lcMethods
  REPLACE methods WITH STRTRAN(lcMethods,"V16.35","V16.39",1,-1,1) IN v36version
 ENDIF
ENDSCAN
USE IN v36version
...
PROCEDURE Click
* V16.39 POSITION CLAIMS TO THE RIGHT OF PATIENTS
...
IF FOUND() AND "V16.35 SINGLE LETTERBUILDER" $ v36patients.methods
 REPLACE methods WITH STRTRAN(v36patients.methods,"V16.35 SINGLE LETTERBUILDER","V16.39 SINGLE LETTERBUILDER",1,1,1) IN v36patients
ENDIF
USE IN v36patients
...
BUILD EXE (lcOutput+"MOST_V16_39_XP_LETTER_DETAILS_RX_SPHERE.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS V16.39 1.7.640 "+TTOC(DATETIME(),1)+CHR(13)+CHR(10),lcLog,0)
ON ERROR
QUIT
...
MESSAGEBOX(lcError,16,"MOSt V16.39 build")
CANCEL
ENDPROC