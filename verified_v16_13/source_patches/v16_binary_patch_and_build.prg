...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_13.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_13_SERVER_FEE_FORM_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.13 server-backed fee form build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
