...
IF FILE("K:\Program Files\MOSt\databases\oms.dbc")
 ...
 IF RLOCK("parameter2")
  REPLACE parameter2.data_files WITH path_to_data
  UNLOCK IN parameter2
 ENDIF
ENDIF
...
IF .F. AND FILE(gc_datadrive+"update\fileversion.xml")
...
llV1615CodeOnly = INLIST(normalized_version(m_current_most_ver), ;
	normalized_version("1.7.640"), normalized_version("1.7.641"), normalized_version("1.7.642"), normalized_version("1.7.643"), normalized_version("1.7.644"), normalized_version("1.7.645"), normalized_version("1.7.646"), normalized_version("1.7.647"), normalized_version("1.7.648"), normalized_version("1.7.649"), normalized_version("1.7.650"), normalized_version("1.7.651"), normalized_version("1.7.652"), normalized_version("1.7.653"), normalized_version("1.7.654"), normalized_version("1.7.655"), normalized_version("1.7.656"), normalized_version("1.7.657"), normalized_version("1.7.658"), normalized_version("1.7.659"), normalized_version("1.7.660"), normalized_version("1.7.661"), normalized_version("1.7.662"), normalized_version("1.7.663"), normalized_version("1.7.664")) ;
...
IF !(JUSTDRIVE(path_to_data) == JUSTDRIVE(oms_local_fullpath)) && this is a client machine
	...
	ENDIF
	IF .F. AND !(server_vsn == m_current_most_ver) AND !llV1615CodeOnly AND !llLegacySchemaVersion
...
IF .F. AND normalized_version(m_current_most_ver) > normalized_version(most_ver) AND !llV1615CodeOnly AND !llLegacySchemaVersion
	WAIT "New version of MOSt detected - Upgrading..." WINDOW AT 16,40 TIMEOUT 2
	DO upgrade.prg && after running this, it will quit
ENDIF
*** <- 2002.05.01
