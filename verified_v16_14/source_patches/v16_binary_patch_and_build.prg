...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_14.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_14_CLEAN_FEE_FORM_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.14 clean server-backed fee form build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
