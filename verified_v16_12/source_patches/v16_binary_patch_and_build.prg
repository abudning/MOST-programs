...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_12.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_12_FEE_RECONCILE_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.12 corrected reconciliation tag build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
