...
DEFINE CLASS RxGlassesForm AS Form
    ...
    PROCEDURE PreviewRx
        ...
        lcHtml=lcHtml+"<tr><td>OD</td><td>"+RxHtml(RxSigned(THIS.txtODSph.Value))+"</td><td>"+RxHtml(RxSigned(THIS.txtODCyl.Value))+"</td><td>"+RxHtml(THIS.txtODAxis.Value)+"</td><td>"+RxHtml(THIS.txtODAdd.Value)+"</td></tr>"
        lcHtml=lcHtml+"<tr><td>OS</td><td>"+RxHtml(RxSigned(THIS.txtOSSph.Value))+"</td><td>"+RxHtml(RxSigned(THIS.txtOSCyl.Value))+"</td><td>"+RxHtml(THIS.txtOSAxis.Value)+"</td><td>"+RxHtml(THIS.txtOSAdd.Value)+"</td></tr></table>"
        lcHtml=lcHtml+"<p><b>Prism:</b> "+RxHtml(lcPrism)+"</p><p><b>Use:</b> "+RxHtml(THIS.txtUse.Value)+"</p>"
        lcHtml=lcHtml+"<p><b>Notes:</b> "+RxHtml(THIS.edtNotes.Value)+"</p>"
    ...
    PROCEDURE Click
        ...
        IF RxReadWordRefraction(@lcSource,@ldDate,@lnODS,@lnODC,@lnODA,@lnOSS,@lnOSC,@lnOSA,@lnODAdd,@lnOSAdd)
            IF MESSAGEBOX("Complete refraction found:"+CHR(13)+;
                ...
                IF lnODAdd>0
                    THISFORM.txtODAdd.Value=lnODAdd
                    THISFORM.txtOSAdd.Value=lnOSAdd
                ENDIF
