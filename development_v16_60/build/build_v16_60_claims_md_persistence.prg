...
lcBackup=lcRoot+"backup_v16_60_claims_md_persistence_20260914\"
lcLog=lcOutput+"build_v16_60_claims_md_persistence.log"
...
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\openletterwriter_v16_57.prg" TO (lcPrograms+"openletterwriter.prg")
...
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\rxcenter_v16_51.prg" TO (lcPrograms+"rxcenter.prg")
COPY FILE "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\openpatientclaim_v16_60.prg" TO (lcPrograms+"openpatientclaim.prg")
...
* V16.60: K: is already mapped to the most-Root share; do not repeat the share name.
lcText=STRTRAN(lcText,'K:\most-root\program files\most\databases\','K:\Program Files\MOSt\databases\',1,-1,1)
lcOld='normalized_version("1.7.660")) ;'
lcNew='normalized_version("1.7.660"), normalized_version("1.7.661")) ;'
* Keep the VFP INLIST argument count within its legacy limit by dropping the oldest code-only build.
lcText=STRTRAN(lcText,'normalized_version("1.7.636"), ','',1,1,1)
IF lcOld $ lcText
 STRTOFILE(STRTRAN(lcText,lcOld,lcNew,1,1,1),lcOms,0)
ELSE
 IF !('normalized_version("1.7.661")' $ lcText)
...
SCAN
 ...
 IF "V16.59" $ lcProps
  REPLACE properties WITH STRTRAN(lcProps,"V16.59","V16.60",1,-1,1) IN v36version
 ENDIF
 IF "V16.59" $ lcMethods
  REPLACE methods WITH STRTRAN(lcMethods,"V16.59","V16.60",1,-1,1) IN v36version
 ENDIF
ENDSCAN
USE IN v36version
...
PROCEDURE Click
* V16.60 POSITION CLAIMS TO THE RIGHT OF PATIENTS
...
IF FOUND() AND "V16.35 SINGLE LETTERBUILDER" $ v36patients.methods
 REPLACE methods WITH STRTRAN(v36patients.methods,"V16.35 SINGLE LETTERBUILDER","V16.60 SINGLE LETTERBUILDER",1,1,1) IN v36patients
ENDIF
USE IN v36patients
DO "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\patch_patients_layout_v16_58.prg" WITH lcForms+"patients.scx"
DO "C:\Users\abudn\Documents\Codex\2026-09-12\wh\work\patch_scheduler_menu_v16_59.prg" WITH lcMenu+"main_menu.mnx"
...
BUILD EXE (lcOutput+"MOST_V16_60_XP_CLAIMS_MD_PERSISTENCE.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS V16.60 1.7.661 "+TTOC(DATETIME(),1)+CHR(13)+CHR(10),lcLog,0)
ON ERROR
QUIT
...
MESSAGEBOX(lcError,16,"MOSt V16.60 build")
CANCEL
ENDPROC
