...
lcLog = ADDBS(lcRoot) + "output\direct_build_v16_9.log"
SET SAFETY OFF
SET EXCLUSIVE ON
...
BUILD EXE (ADDBS(lcRoot) + "output\MOST_V16_9_RUNNING_EXE_VERSION_TEST.exe") FROM "most.pjx" RECOMPILE
STRTOFILE("SUCCESS: V16.9 running executable version check build completed" + CHR(13)+CHR(10), lcLog, 0)
ON ERROR
QUIT
